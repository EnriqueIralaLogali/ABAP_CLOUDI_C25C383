CLASS zcl_select_sql_one_log_c383 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_select_sql_one_log_c383 IMPLEMENTATION.
...
*    ENDIF.
    ...
    DATA: lt_airlines TYPE STANDARD TABLE OF zcarrier_c383.
...
*     INTO CORRESPONDING FIELDS OF TABLE @lt_flights2.
*
*    IF sy-subrc = 0.
*
...
*
*    SELECT SINGLE
*    FROM zcarrier_c383 USING CLIENT '200'
*          FIELDS *
*           INTO @DATA(lt_flights).
*
*
...
*    WHERE AirlineID = @lt_flights-carrier_id
...
*    ENDIF.
    ...
    "DATA: lv_search_criteria TYPE string VALUE '%__egel%'.

*     DATA: lv_search_criteria TYPE string VALUE '%erlin%'.
*
...
*    MODIFY zcarrier_c383 FROM @( VALUE #( carrier_id = 'AV'
*                                             name = 'AVIANCA%'
*                                    currency_code = 'COP' ) ) .
*
